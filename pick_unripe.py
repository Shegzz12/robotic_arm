...
TARGET_BASE_ANGLE = 170.0  # Execution 3 Drop Location (MAX)
...
# ==========================================
# MAIN EXECUTION: DROP AT 170°
# ==========================================
print("==========================================")
print("  EXECUTION 3: PICK AT 57.5° -> DROP AT 170° -> HOME")
print("==========================================")
...
try:
    ...
    # --------------------------------------
    # 3. BASE ROTATION TO 170.0°
    # --------------------------------------
    print("\n--- PHASE 2: BASE ROTATION TO DROP LOCATION 3 (170.0°) ---")
    print(f"Rotating Base ({HOME_BASE_ANGLE} -> {TARGET_BASE_ANGLE} deg)...")
    move_to_angle_smooth(base, HOME_BASE_ANGLE, TARGET_BASE_ANGLE, name="Base (GPIO 18)", steps=100, step_delay=0.04)
    sleep(0.8)

    # --------------------------------------
    # 4. LOWER ARM & DROP
    # --------------------------------------
    print("\n--- PHASE 3: LOWER ARM & DROP AT 170.0° ---")
    ...
    move_to_angle_smooth(base, TARGET_BASE_ANGLE, HOME_BASE_ANGLE, name="Base (GPIO 18)", steps=100, step_delay=0.04)
    sleep(0.8)

    print("\nExecution 3 complete successfully!")

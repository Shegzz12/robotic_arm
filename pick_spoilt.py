...
TARGET_BASE_ANGLE = 15.0   # Execution 1 Drop Location (MIN)
...
# ==========================================
# MAIN EXECUTION: DROP AT 15°
# ==========================================
print("==========================================")
print("  EXECUTION 1: PICK AT 57.5° -> DROP AT 15° -> HOME")
print("==========================================")
...
try:
    # --------------------------------------
    # 1. INITIALIZATION AT HOME
    # --------------------------------------
    print("Engaging servos at default home positions...")
    ...
    # --------------------------------------
    # 3. BASE ROTATION TO 15.0°
    # --------------------------------------
    print("\n--- PHASE 2: BASE ROTATION TO DROP LOCATION 1 (15.0°) ---")
    ...
    # 4. LOWER ARM & DROP
    # --------------------------------------
    print("\n--- PHASE 3: LOWER ARM & DROP AT 15.0° ---")
    ...
    print("\nExecution 1 complete successfully!")

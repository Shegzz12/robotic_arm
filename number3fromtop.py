...
# ==========================================
MIN_ANGLE = 80.0   # Closed grip position in degrees (0 to 180)
MAX_ANGLE = 178.0  # Open grip position in degrees (0 to 180)
...
# Initialize GPIO 24 (Physical Pin 18)
grip = Servo(24, pin_factory=factory, min_pulse_width=PULSE_MIN, max_pulse_width=PULSE_MAX)
...
# ==========================================
print("==========================================")
print("     GPIO 24 GRIPPER VERIFICATION TEST    ")
print("==========================================")
...
try:
    ...
    grip.detach()
    print("Servo on GPIO 24 detached safely.")
